...
module.exports = async (options) => {
	...
	if (!options.embed.title) {
		options.embed.title = 'Would you rather... | installastion Development';
	}
	...
	if (typeof options.thinkMessage !== 'string') {
		throw new TypeError(' Error: thinkMessage must be a boolean.');
	}
	...
	if (typeof options.buttons.optionA !== 'string') {
		throw new TypeError(' Error: button must be a string.');
	}
